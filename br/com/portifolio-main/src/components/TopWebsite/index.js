                ...
                <div className="interface">
                    <div className="flex">
                        <div className="txt-top-text">
                            ...
                            <p>
                                Criatividade e inovação andam lado a lado. Com uma combinação única de desing
                                impactante, funcionalidades intuitiva e otimização para resultados, estou pronto
                                para criar a presença online dos seus sonhos.
                            </p>
